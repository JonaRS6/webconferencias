        ...
        <div class="col-md-12">
          ...
          <section class="content">
            ...
            <div class="box">
              ...
              <div class="box-body">
                <form role="form" name="crear-registrado" id="crear-registro" method="post" action="modelo-registrado.php">
                  <div class="box-body">
                    <div id="datos_usuario" class="registro caja clearfix">
                      ...
                      <div class="campo form-group col-xs-6">
                        ...
                        <input class="form-control" type="text" id="apellido" name="apellido" placeholder="Tu apellido" required>
                      </div>
                      <div class="campo form-group">
                        <label for="email">Email: </label>
                        <input class="form-control" type="email" id="email" name="email" placeholder="Tu email" required>
                      </div>
                      <div id="error"></div>
                    </div>
